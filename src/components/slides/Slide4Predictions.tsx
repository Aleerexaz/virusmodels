  ...
  return (
    <div className="w-full h-screen overflow-hidden flex flex-col bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          <div className="flex items-center justify-center gap-3 mb-2">
            ...
            <h1 className="text-2xl font-semibold bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 bg-clip-text text-transparent">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        >
          <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-gradient-to-br from-slate-900/40 to-slate-800/20 backdrop-blur-sm border-r border-white/5">
          {activeSection === 'r0' && (
            <>
